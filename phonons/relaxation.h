...
namespace PHON_NS {
    ...
    public:
		...
		void selfenergy_f(const unsigned int, double *, const double, const unsigned int, const unsigned int, std::complex<double> *);
		void selfenergy_g(const unsigned int, double *, const double, const unsigned int, const unsigned int, std::complex<double> *);
		void selfenergy_h(const unsigned int, double *, const double, const unsigned int, const unsigned int, std::complex<double> *);
		void selfenergy_i(const unsigned int, double *, const double, const unsigned int, const unsigned int, std::complex<double> *);
