...
#
"""
This python script generates VASP POSCAR files for given displacement configurations.
"""
...
parser.add_option('--prefix', help="Prefix of the files to be created (default: None)")
...
def write_POSCAR(prefix, counter, header, nzerofills, lavec, elems, nat, disp, coord):
...
if __name__ == '__main__':
	...
	if options.poscar == None:
		...
		print "--poscar option not given. Default value will be used."
	else:
		fname_poscar_orig = options.poscar
	...
	for pattern in disp_pattern:
		...
		write_POSCAR(prefix, counter, header, nzerofills, aa, elems, nats, disp, x_frac)

	print 
	print "All POSCAR files are created."
